...
int main(int argc, char* argv[])
{
	...
	//cout << imstackin.imageDepth << " " << imstackin.imageWidth <<" "<< imstackin.bigtiff<<" "<< totnumofframes<< "\n";

	BLTiffIO::TiffOutput imstackout(output, imageWidth, imageHeight, imageDepth, imstackin.bigtiff);

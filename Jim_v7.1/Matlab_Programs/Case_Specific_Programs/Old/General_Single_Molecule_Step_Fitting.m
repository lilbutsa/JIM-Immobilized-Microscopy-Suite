...
for i=1:NumberOfFiles
    ...
    traces=csvread(channel1{i},1)./singleMoleculeIntensity;
    ...
    for traceCount = 1:size(filteredTraces,1)
        ...
        if traceCount > 36*(pageNumber-1)&& traceCount <= 36*(pageNumber) && i==fileToPlot
    ...
    allResults{i} = expResults;
    allPosStepDeltaT{i} = expPosStepDeltaT;
    allNegStepDeltaT{i} = expNegStepDeltaT;

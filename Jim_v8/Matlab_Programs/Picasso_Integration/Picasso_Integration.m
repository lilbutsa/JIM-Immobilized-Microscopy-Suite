...
%%
washoutframes = csvread('G:\Group_Jim_Data\Conall\201012_PFO_Washout_50ms5mw20mw\AllSolutionExchangesManual.csv',1,0);
%% 2) Organise Channels 
numberOfChannels = 2;

%Transform channels so they roughly overlay each other
channelsToTransform = '2';%If no channels need to be transformed set channelsToTransform = '';
VerticalFlipChannel = '1';
HorizontalFlipChannel = '0';
RotateChannel = '0';%rotate should either be 0, 90 180 or 270 for the angle to rotate each selected channel

startFrame = washoutframes(1,1);
endFrame = -1;
...
%Thresholding
cutoff=0.5; % The cutoff for the initial thresholding
...
backgroundDetectionStartFrame = '1 1';
backgroundDetectionEndFrame = '10 10';
...
%%    
workingDir = 'G:\Group_Jim_Data\Conall\201012_PFO_Washout_50ms5mw20mw\201016_NewPFO_500pM_20spf_P4C5_1\201016_NewPFO_500pM_20spf_P4C5_1_MMStack_Pos0\';
channelNum = 2;  

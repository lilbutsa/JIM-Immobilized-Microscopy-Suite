...
if(~exists(sysConst.JIM))
    errordlg('JIMs c++ Base Programs could not be automatically found. Please select the \\c++_Base_Programs\\ folder and operating systems subfolder'); 
    sysConst.JIM = uigetdir('*','Select the c++_Base_Programs\\[operating system] folder'); % open the dialog box to select the folder for JIM programs
    sysConst.JIM=[sysConst.JIM,filesep];
end

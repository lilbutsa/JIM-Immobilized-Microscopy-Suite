...
public:
    ...
    void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
        ...
        bool skipIndependentDrifts = inputs[inputs.size() - minNumOfInputs + 6][0];
        double maxShift = inputs[inputs.size() - minNumOfInputs + 7][0];
        bool outputAligned = inputs[inputs.size() - minNumOfInputs + 8][0];
